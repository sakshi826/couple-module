  ...
  return (
    <ScreenWrapper>
      ...
      <div className="space-y-6 w-full max-w-xs">
        ...
        <h2 className="text-2xl font-heading font-semibold text-foreground">Take your time 🕯️</h2>
        ...
        <textarea
          ...
          placeholder="Write as much or as little as you want… ✍️"
          rows={5}
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="If there's something you'd like to say…"
            rows={3}
